...
def disambiguate_duplicate_spend_references(apps, schema_editor):
    CoinLedger = apps.get_model("billing", "CoinLedger")
    duplicates = (
        CoinLedger.objects.filter(delta__lt=0)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("billing", "0010_coinledger_unique_positive_reference"),
    ]

    operations = [
        migrations.RunPython(disambiguate_duplicate_spend_references, migrations.RunPython.noop),
