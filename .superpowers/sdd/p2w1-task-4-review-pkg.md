...
## git diff executor.py (focused)
```diff

```

## git diff provider_test.py (if any)
```diff

```

## NEW test_v3_failover_executor.py
```python
# -*- coding: utf-8 -*-
"""P2-W1 Task 4锛歟xecutor 缁?llm_router 鏁呴殰杞Щ锛涜瘯杩炰笉鍐?FailoverAttempt銆?""
