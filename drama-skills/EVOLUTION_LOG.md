...
**梳理范围**：全部34个SKILL.md文件

**发现冲突**：

| 等级 | 冲突 | 修复方式 |
|------|------|---------|
| 🔴高 | 场景导演 vs 分镜导演：description均含"分镜表生成" | 场景导演改为"创作阶段镜头语言指导"，不再生成分镜表 |
| 🔴高 | 节奏设计师 vs 节奏优化师：均整合 drama-pacing-optimizer | 节奏设计师改为只整合 drama-plot-rhythm-engine |
| 🔴高 | 爆款公式师 vs 梦境指标师：均做"梦境三指标" | 明确爆款公式师=选题轻量预估，梦境指标师=深度检测 |
| 🟡中 | 情绪架构师/节奏设计师/情绪审计官：时机边界不清 | description内加入"大纲前/大纲中/剧本后"时机标注 |
| 🟡中 | 市场雷达 vs 拉片分析师：竞品分析功能重叠 | 明确宏观趋势 vs 具体作品深度分析 |
| 🟢低 | drama-master 路由数字错误（27→33） | 更新数量，加入易混淆角色分工说明表 |
