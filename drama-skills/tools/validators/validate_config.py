...
from synthesize_matrix_params import resolve_from_matrix  # noqa: E402
...
def main() -> int:
    ...
    overlay = load_yaml("tools/fixtures/config/overlay.yaml")
    project = json.loads(
        (ROOT / "tools/fixtures/config/project-settings.json").read_text(
            encoding="utf-8"
        )
    )
