...
from lib.parameter_schema_generator import (  # noqa: E402
    generated_artifacts,
    generate_parameters_schema,
)
from lib.parameter_resolver import resolve_enum, resolve_max_items  # noqa: E402
from lib.schema_validator import SchemaValidator  # noqa: E402
...
class ParameterSchemaGenerationTests(unittest.TestCase):
    ...
    def test_project_settings_fixture_validates_with_refs(self):
        ...
        project = json.loads(
            (ROOT / "tools/fixtures/config/project-settings.json").read_text(encoding="utf-8")
        )
